...
from remoma.models.gnn.bin import BiN
...
class CGNN(GNNClassifier):
    ...
    def __init__(
        ...
        **_kwargs,
        ...
        # SAGE/GAT typically require a smaller hidden width for a matched
        # parameter budget because their spatial operators use more parameters.
