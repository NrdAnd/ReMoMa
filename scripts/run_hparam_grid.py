...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config-dir", default="runs/generated_configs/hparam_grid")
    parser.add_argument("--walk-forward-config-dir", default="runs/generated_configs/walk_forward_grid")
