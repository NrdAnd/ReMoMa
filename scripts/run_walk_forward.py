...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config-dir", default="runs/generated_configs/walk_forward")
...
def _with_fold_paths(cfg: dict, name: str, fold: dict) -> dict:
    ...
    out["data"]["processed_dir"] = str(base_processed / name / fold_name)

    checkpoints = Path(out["paths"]["checkpoints"])
    out["paths"]["checkpoints"] = str(checkpoints / name / fold_name)
    return out
