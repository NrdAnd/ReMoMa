...
Usage:
    python scripts/tune_threshold.py --config configs/gnn/default.yaml
...
from remoma.models import build_model, is_recurrent_sparse_model, model_names, model_family
...
def main(
    ...
    if model is not None:
        ...
        cfg["model"]["family"] = model_family(model)
