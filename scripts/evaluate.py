...
Usage:
    ...
    python scripts/evaluate.py --checkpoint checkpoints/best.pt --config configs/gnn/default.yaml
"""
...
from remoma.training.metrics import compute_metrics, print_report
...
def main(
    ...
    cfg = checkpoint_config(checkpoint_path, config_path)
    ...
    load_checkpoint_state(model, checkpoint_path, cfg, device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default=None, help="Use the checkpoint configuration when omitted.")
