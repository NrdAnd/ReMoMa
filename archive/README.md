...
`legacy/gnn_v1.py` and `legacy/create_feature.py` retain early research code. Their prose is translated into English, but their computational behavior is preserved for inspection.
