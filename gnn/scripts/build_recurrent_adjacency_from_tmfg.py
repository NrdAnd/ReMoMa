...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input",
        default="../tmfg/cisco_tmfg_adj_matrix_2000_bins.csv",
        help="Existing TMFG adjacency CSV, relative to gnn/ by default.",
    )
    parser.add_argument(
        "--output",
        default="data/adjacency/recurrent_sparse_tmfg_lag100_bins2000_from_full_tmfg_adjacency.tsv",
